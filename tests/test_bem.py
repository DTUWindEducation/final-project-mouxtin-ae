...
from src.performance_curves import plot_cl_cd_vs_alpha_all, plot_cp_ct_surfaces
from src.data_loader import load_airfoil_coordinates
...
def test_load_coords_from_plots_module(tmp_path):
    ...
    from src.plots import load_coords
...
def test_plot_cp_ct_surface_plot(tmp_path):
    from src.performance_curves import plot_cp_ct_surfaces
...
def test_solve_bem_extreme_tip_loss(paths_and_data):
    from src.bem_solver import solve_bem
...
def test_compute_power_thrust_invalid_afid():
    from src.bem_solver import compute_power_thrust_curves
...
from src.plots import load_airfoil_data
...
from src.plots import plot_polar_data
...
from src.plots import plot_coords_data
